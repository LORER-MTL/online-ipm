...
I think that this suggests that there are potentially no simple remedies to the current analysis.}
...
\WZZsuggestion{This seems to require a feasible point that has a small newton step. 
Is it really required to solve an entire optimization problem to find such a point?
